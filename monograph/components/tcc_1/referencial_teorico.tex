...
Observando essas diversas áreas podemos compreender que empresas de pequenos, médios e grandes portes podem ter o seu produto como parte da Economia Criativa. 
Porém diferente de outras modalidades de economia, a Economia Criativa também possibilita outras modalidades de empreendimento.

Segundo~\cite{artista} podemos denominar o termo "Artista Indenpendente" como uma pessoa que utilizar de seus próprios recursos para produzir arte, essa pessoa pode ter ou não experiência profissional e utilizar de recursos pessoais, coletivos ou do estado para poduzir o seu produto de renda.
Dentre esses recursos, hoje podemos observar a internet e o acesso dela a apartir de aplicativos móveis como recursos aliados para esses artistas indenpendentes, seja em ativdades administrativas, sociais, divulgação de trabalho, entre outros~\cite{bittencourt}.
